...
| Ospitare e connettersi a set di dati condivisi di Power BI | No | Sì | [Introduzione ai set di dati in aree di lavoro diverse](../service-datasets-across-workspaces.md) |
