...
* È anche possibile per l'accesso SSO [jiné zdroje dat](desktop-directquery-data-sources.md#single-sign-on-sso-for-directquery-sources) senza usare un gateway dati
