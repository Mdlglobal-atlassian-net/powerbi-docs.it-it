...
* **Condivisione con utenti esterni**: la condivisione è consentita solo all'interno di un tenant di Power BI. Non è possibile condividere con utenti al di fuori del tenant di Power BI.
