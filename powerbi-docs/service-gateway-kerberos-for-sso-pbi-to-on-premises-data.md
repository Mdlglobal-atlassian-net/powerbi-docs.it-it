...
Sono attualmente supportate le origini dati seguenti, tutte basate sulla [delega vincolata Kerberos](https://technet.microsoft.com/library/jj553400.aspx):
...
> [!NOTE]
> Per abilitare SSO per SAP HANA:
>
