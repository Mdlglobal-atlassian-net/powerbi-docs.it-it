...
> 
> [!IMPORTANT]
> Gli amministratori di Power BI possono disabilitare la possibilità per gli utenti di usare Pubblica sul Web dal portale di amministrazione. In **Impostazioni tenant** impostare **Pubblica sul Web** su **Disattiva**. È un'impostazione a livello di tenant. Per altre informazioni, vedere [Portale di amministrazione di Power BI](service-admin-portal.md).
> 
> 
