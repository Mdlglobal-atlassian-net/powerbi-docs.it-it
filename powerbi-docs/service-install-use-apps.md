...
Se si prevede di creare un'app, Per altre informazioni, vedere [Creare aree di lavoro con i colleghi in Power BI](service-create-distribute-apps.md).
...
È ora possibile esplorare i dati nei dashboard e nei report nell'app. È possibile accedere a tutte le interazioni standard di Power BI, ad esempio i filtri, l'evidenziazione, l'ordinamento e il drill-down. È anche possibile [esportare i dati in Excel ](visuals/power-bi-visualization-export-data.md) da una tabella o da altri oggetti visivi in un report. Vedere [Interagire con i report in Power BI](service-reading-view-and-editing-view.md). 
