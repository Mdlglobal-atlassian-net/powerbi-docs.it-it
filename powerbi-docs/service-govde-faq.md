...
5. **È possibile usare Power BI Desktop, Power BI per dispositivi mobili, Gateway dati locale e Publisher per Excel con il servizio Power BI per Cloud Germania?**
   ...
   * [On-premises data gateway (Gateway dati locale)](https://powerbi.microsoft.com/gateway/)
...
| Libreria di oggetti visivi di Power BI |[https://app.powerbi.de/visuals/](https://app.powerbi.de/visuals/) |[https://app.powerbi.com/visuals/](https://app.powerbi.com/visuals/) |
