...
ms.locfileid: "66187564"
---
# <a name="filters-and-highlighting-in-power-bi-reports"></a>Filtri ed evidenziazione nei report di Power BI
 Questo articolo viene presentato il filtraggio ed evidenziazione nel servizio Power BI. L'esperienza è quasi identica in Power BI Desktop. Con i *filtri* viene rimosso tutto tranne i dati rilevanti. *L'evidenziazione* non è il filtro. Non rimuovere i dati, ma invece evidenzia un subset di dati visibili. i dati non evidenziati restano visibili ma in grigio.
...
* Introduzione ai filtri ed evidenziazione, l'articolo si sta leggendo a questo punto.
* Saper [creare e usare i filtri nella visualizzazione di modifica](power-bi-report-add-filter.md) nei report in Power BI Desktop e nel servizio Power BI. Quando si hanno le autorizzazioni di modifica per un report, è possibile creare, modificare ed eliminare i filtri nei report.
* Come gli oggetti visivi [filtrare ed evidenziare in un report condiviso con l'utente](consumer/end-user-interactions.md), nella visualizzazione di lettura nel servizio Power BI del report. Le operazioni possibili sono più limitate, ma è comunque disponibile un'ampia gamma di opzioni di filtro ed evidenziazione.  
* Una descrizione dettagliata dei [filtro ed evidenziazione disponibili nella visualizzazione di modifica di controlli](power-bi-report-add-filter.md) in Power BI Desktop e nel servizio Power BI. L'articolo richiede un sguardo approfondito sui tipi di filtri, ad esempio data e ora, numerico e il testo. Vengono inoltre illustrate le differenze tra le opzioni di base e avanzate.
...
![Filtri a livello visivo](media/power-bi-reports-filters-and-highlighting/power-bi-filter-visual-level.png)
...
![Reimpostare icona predefinita](media/power-bi-reports-filters-and-highlighting/power-bi-reset-to-default.png)
...
## <a name="ad-hoc-highlighting"></a>L'evidenziazione ad hoc
Selezionare un'etichetta dell'asse o valore in un oggetto visivo per evidenziare gli altri oggetti visivi nella pagina. Per rimuovere l'evidenziazione, selezionare di nuovo il valore oppure selezionare lo spazio vuoto nello stesso oggetto visivo. L'evidenziazione è un divertente esplorare rapidamente l'impatto sui dati. Per ottimizzare il funzionamento di questo tipo di evidenziazione incrociata, vedere [Interazioni tra oggetti visivi](service-reports-visual-interactions.md).
...
[La nuova esperienza di filtro nei report di Power BI](power-bi-report-filter-preview.md)
