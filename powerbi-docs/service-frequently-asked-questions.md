...
## <a name="power-bi-desktops-software-license-terms-say-you-may-install-and-use-one-copy-of-the-software-on-your-premises"></a>Le Condizioni di licenza software di Power BI Desktop indicano che è possibile installare e usare una sola copia del software in locale.
### <a name="does-this-mean-i-am-limited-to-one-copy-of-power-bi-desktop-for-the-entire-company"></a>Questo significa che esiste un limite di una sola copia di Power BI Desktop per l'intera società?
I diritti di utilizzo di Power BI Desktop non limitano a una sola copia di Power BI Desktop per l'intera società. Ogni singolo utente presso la società può installare e usare una copia in locale.
