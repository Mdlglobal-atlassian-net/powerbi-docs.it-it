...
In Power BI è possibile [connettersi alle cartelle di lavoro di Excel in OneDrive for Business](../connect-data/service-excel-workbook-files.md) e aggiungere riquadri a un dashboard dalla cartella di lavoro. Quando si condividono i dashboard oppure si crea un pacchetto di contenuto che include tale dashboard:
...
* [Aggiungere un riquadro a un dashboard di Power BI da Excel](../create-reports/service-dashboard-pin-tile-from-excel.md)
