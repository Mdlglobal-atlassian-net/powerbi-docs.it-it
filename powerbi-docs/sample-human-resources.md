...
Nella casella della domanda in [Domande e risposte](service-how-to-q-and-a.md) è possibile digitare la domanda usando il linguaggio naturale. Domande e risposte riconosce le parole digitate e determina la posizione nel set di dati in cui trovare la risposta.
