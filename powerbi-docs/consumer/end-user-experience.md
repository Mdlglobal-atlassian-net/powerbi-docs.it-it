...
1. Selezionare **Home page** se la pagina non è già aperta. 
...
![Schermata Area di lavoro per le app](./media/end-user-experience/power-bi-app-workspace.png)
...
## <a name="power-bi-home"></a>Home page di Power BI
