...
1. Aprire app.powerbi.com e selezionare il collegamento **Esempi**. 
    ...
    ![aprire il servizio Power BI per la prima volta](./media/end-user-experience/power-bi-new-user.png)

2. Selezionare **Esempio di analisi delle vendite al dettaglio > Connetti**.

    ![selezionare l'esempio](./media/end-user-experience/power-bi-retail-sample.png)
...
![Aprire i dashboard](./media/end-user-experience/power-bi-open-dashboard.png)
...
1. Con il dashboard aperto, selezionare **Aggiungi a Preferiti** nell'angolo in alto a destra.
   ...
   ![Aggiungere a Preferiti](./media/end-user-experience/powerbi-dashboard-favorite.png)
...
4. Selezionare il nome del report per aprirlo nell'editore del report.
    ...
    ![aprire un report](./media/end-user-experience/power-bi-report-open.png)
