...
* Le sottoscrizioni tramite posta elettronica non supportano la maggior parte degli [oggetti visivi di Power BI](../developer/visuals/power-bi-custom-visuals.md).  L'unica eccezione è costituita dagli oggetti visivi di Power BI che sono stati [certificati](../developer/visuals/power-bi-custom-visuals-certified.md).  
