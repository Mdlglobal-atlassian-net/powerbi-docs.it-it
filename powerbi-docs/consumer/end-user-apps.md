...
![App in Power BI](./media/end-user-apps/power-bi-apps-left-nav.png)
...
Se si prevede di creare un'app, Per altre informazioni, vedere [Creare aree di lavoro con i colleghi in Power BI](end-user-create-apps.md).
...
* [Creare e pubblicare app in Power BI](end-user-create-apps.md)
