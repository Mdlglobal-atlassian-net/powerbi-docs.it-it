...
La visualizzazione di modifica è disponibile solo agli autori del report o ai colleghi che sono [comproprietari di un report in quanto membri o amministratori di un'area di lavoro delle app](end-user-create-apps.md).
...
| [Eliminare un report](end-user-delete.md) | No  | Sì |
|**Pagine del report** |
...
| [Eliminare una pagina di un report](end-user-delete.md) | no | sì |
...
| [Eliminare una visualizzazione, una casella di testo o una forma](end-user-delete.md)| No | Sì |
