...
2. Trovare il dashboard da eliminare e selezionare l'icona Elimina ![Icona Elimina](./media/end-user-delete/power-bi-delete-icon.png).
...
2. Trovare il report da eliminare e selezionare l'icona Elimina   ![Icona Elimina](./media/end-user-delete/power-bi-delete-icon.png).   

    ![Scheda Report dell'area di lavoro](./media/end-user-delete/power-bi-delete-reportnew.png)
3. Confermare l'eliminazione.

   ![Finestra di dialogo Elimina report](./media/end-user-delete/power-bi-delete-report.png)
...
2. Trovare la cartella di lavoro da eliminare e selezionare l'icona Elimina ![Icona Elimina](./media/end-user-delete/power-bi-delete-report2.png) .

    ![Scheda Cartelle di lavoro](./media/end-user-delete/power-bi-delete-workbooknew.png)
3. Confermare l'eliminazione.

   ![Finestra di dialogo Rimuovi cartella di lavoro](./media/end-user-delete/power-bi-delete-confirm.png)
...
2. Trovare il set di dati da eliminare e scegliere i puntini di sospensione (...).  
    ...
    ![Scheda Set di dati](./media/end-user-delete/power-bi-delete-datasetnew.png)
3. Nel menu a discesa, selezionare **Elimina**.

   ![Menu di puntini di sospensione](./media/end-user-delete/power-bi-delete-datasetnew2.png)
4. Confermare l'eliminazione.

   ![Finestra di dialogo Elimina dashboard](./media/end-user-delete/power-bi-delete-dataset-confirm.png)
...
1. Nel riquadro di spostamento a sinistra, selezionare **Aree di lavoro**
    ...
    ![Aree di lavoro per le app](./media/end-user-delete/power-bi-delete-workspace.png)
2. Selezionare i puntini di sospensione (...) a destra dell'area di lavoro da eliminare e scegliere **Modifica area di lavoro**.

   ![Menu di puntini di sospensione > Modifica area di lavoro](./media/end-user-delete/power-bi-edit-workspace.png)
3. Nella finestra **Modifica area di lavoro**, selezionare **Elimina area di lavoro** > **Elimina**.

    ![Eliminare l'area di lavoro](./media/end-user-delete/power-bi-delete-workspace2.png)
...
2. Nell'angolo in alto a destra selezionare i puntini di sospensione (...) e scegliere **Lascia l'area di lavoro** > **Esci**.
      ...
      ![Lasciare l'area di lavoro](./media/end-user-delete/power-bi-leave-workspace.png)
...
2. Passare il puntatore sopra l'app da eliminare e selezionare l'icona Elimina ![](./media/end-user-delete/power-bi-delete-report2.png).

   ![Selezionare le app](./media/end-user-delete/power-bi-delete-app.png)

   Se si rimuove un'app accidentalmente, sono disponibili diverse opzioni per recuperarla.  È possibile chiedere all'autore dell'app di inviarla nuovamente, è possibile trovare il messaggio originale con il collegamento all'app, è possibile controllare il [Centro notifiche](end-user-notification-center.md) per verificare se la notifica relativa a tale app è ancora elencata oppure è possibile controllare l'[AppSource](end-user-apps.md) dell'organizzazione.
...
* [Rimuovere il dashboard in primo piano](end-user-featured.md#change-the-featured-dashboard)
* [Rimuovere un dashboard dai Preferiti](end-user-favorite.md)
* [Eliminare una pagina del report](end-user-delete.md)
* [Eliminare un riquadro del dashboard](../service-dashboard-edit-tile.md)
* [Eliminare una visualizzazione del report](end-user-delete.md)
