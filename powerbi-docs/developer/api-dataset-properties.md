...
dataType     |  Stringa       |  [Tipi di dati EDM](https://msdn.microsoft.com/library/ee382832.aspx) e restrizioni supportati. Vedere [Restrizioni del tipo di dati](#DataTypeRestrictions).      |  False       | True        
