...
Se si intende incorporare i dashboard e i report per i clienti, questi devono essere inseriti all'interno di un'area di lavoro per le app. Per informazioni su come creare un'area di lavoro per le app, vedere [Creare un'area di lavoro per le app](../service-create-distribute-apps.md#create-an-app-workspace).
