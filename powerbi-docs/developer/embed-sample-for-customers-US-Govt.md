---
title: Incorporare contenuto di Power BI in un'applicazione per i clienti per US Government
...
---
# <a name="embed-a-power-bi-dashboard-tile-or-report-into-your-application-for-us-government"></a>Incorporare un dashboard, un riquadro o un report di Power BI nell'applicazione per US Government
...
Diversamente dal cloud pubblico, il cloud US Government ha tre diverse sezioni di categorie.
...
Per eseguire questa procedura dettagliata, è necessario un account **US Government Power BI**. Se l'account non è stato configurato, è possibile [iscriversi per ottenere un account Power BI per enti pubblici](../service-govus-signup.md).
...
È necessario registrare l'applicazione in Azure AD per effettuare chiamate all'API REST. Per altre informazioni, vedere [Registrare un'app di Azure AD per incorporare il contenuto di Power BI](register-app.md). Poiché esistono tre diverse sezioni di categorie a seconda del tipo di ente pubblico, esistono tre URL distinti per registrare l'applicazione.
...
Nell'applicazione è prima di tutto necessario ottenere un **token di accesso** da Azure AD prima di effettuare chiamate all'API REST di Power BI. Per altre informazioni, vedere [Autenticare gli utenti e ottenere un token di accesso di Azure AD per l'app Power BI](get-azuread-access-token.md). Poiché esistono tre diverse sezioni di categorie a seconda del tipo di ente pubblico, esistono due URL distinti per ottenere un token di accesso per l'applicazione.

* Government Community Cloud (GCC) (Cloud della community per enti pubblici): login.microsoftonline.com

* Military Contractors (DoDCON) (Contractor militari - DoDCON): login.microsoftonline.us

* Military (DoD) (Esercito -DoD): login.microsoftonline.us
