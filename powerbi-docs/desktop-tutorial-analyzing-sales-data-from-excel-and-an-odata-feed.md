...
2. Nella finestra di dialogo **Feed OData** incollare l'URL del feed Northwind OData `http://services.odata.org/V3/Northwind/Northwind.svc/`. Selezionare **OK**.
