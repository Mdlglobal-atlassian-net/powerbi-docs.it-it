...
| [Usare il riquadro Filtri del report](power-bi-how-to-report-filter.md) | Sì, è possibile usare i filtri esistenti ma le modifiche non vengono salvate insieme al report. | Sì |
