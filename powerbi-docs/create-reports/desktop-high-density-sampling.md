...
## <a name="how-to-turn-on-high-density-line-sampling"></a>Come abilitare il campionamento di linee ad alta densità
Per impostazione predefinita, il nuovo algoritmo è **attivato**. Per modificare questa impostazione, passare al riquadro **Formattazione** nella scheda **Generale** e nella parte inferiore sarà visibile un dispositivo di scorrimento denominato **Campionamento ad alta densità**. Per disattivarlo, scorrere verso **Disattiva**.
