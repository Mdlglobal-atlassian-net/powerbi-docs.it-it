...
### <a name="create-and-customize-a-theme-in-power-bi-desktop"></a>Creare e personalizzare un tema in Power BI Desktop
...
La tabella seguente visualizza le sei classi di colori che è possibile formattare.  Il nomi di **classe di colori** corrispondono ai nomi riportati nella sottosezione "Avanzate" della sezione "Nome e colori" della finestra di dialogo [**Personalizza tema**](#create-and-customize-a-theme-in-power-bi-desktop).
