...
1. Se non esiste già un campo con un collegamento ipertestuale nel set di dati, aggiungerlo come [colonna personalizzata](../transform-model/desktop-common-query-tasks.md) in Power BI Desktop.
