...
1. Passare alla [visualizzazione dati](../connect-data/desktop-data-view.md) selezionando l'icona di tabella ![icona di tabella](media/sample-tutorial-connect-to-the-samples/power-bi-data-icon.png).
...
1. Passare alla [visualizzazione relazioni](../transform-model/desktop-relationship-view.md) selezionando l'icona seguente: ![Icona della visualizzazione relazioni](media/sample-tutorial-connect-to-the-samples/power-bi-desktop-relationship-icon.png).
