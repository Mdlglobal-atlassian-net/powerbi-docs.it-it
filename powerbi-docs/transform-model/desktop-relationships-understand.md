...
Per altre informazioni, vedere [Linee guida per relazioni attive e inattive](../guidance/relationships-active-inactive.md).
...
>
> Per altre informazioni, vedere l'articolo [Considerare le impostazioni di integrità referenziale in Power BI Desktop](../connect-data/desktop-assume-referential-integrity.md).
