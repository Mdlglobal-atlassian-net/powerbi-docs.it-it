...
Questo articolo descrive le opzioni disponibili per iscriversi ed iniziare a usare il servizio Power BI. Per altre informazioni sulle differenze a livello di funzionalità tra i tipi di licenza di Power BI, vedere [Funzionalità di Power BI in base al tipo di licenza](service-features-license-type.md).

## <a name="you-have-a-few-options"></a>Ci sono diverse opzioni disponibili
...
> [!NOTE]
> È possibile effettuare l'iscrizione a Power BI con indirizzi .gov o .mil. Per altre informazioni, vedere [Registrare l'organizzazione governativa statunitense al servizio Power BI](https://docs.microsoft.com/power-bi/service-govus-signup).
>

> [!NOTE]
> Dopo l'iscrizione è possibile [invitare utenti guest](https://docs.microsoft.com/azure/active-directory/active-directory-b2b-what-is-azure-ad-b2b) alla visualizzazione di contenuti nel tenant di Power BI con qualsiasi indirizzo di posta elettronica, inclusi gli account personali.
>
