...
Le aree di lavoro sono posizioni in cui gli utenti possono collaborare a dashboard, report e altro contenuto. Gli amministratori usano l'impostazione **Crea aree di lavoro (nuova esperienza delle aree di lavoro)** per indicare quali utenti dell'organizzazione possono creare aree di lavoro. Gli amministratori possono consentire a qualsiasi utente dell'organizzazione o a nessuno di questi di creare aree di lavoro con la nuova esperienza. Possono anche limitare la creazione ai membri di gruppi di sicurezza specifici. Vedere altre informazioni sulle [aree di lavoro](service-new-workspaces.md).
...
Per altre informazioni, vedere [Introduzione ai set di dati in aree di lavoro diverse](service-datasets-across-workspaces.md).
