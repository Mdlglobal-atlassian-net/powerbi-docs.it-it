...
Osservare come vengono create alcune visualizzazioni e quindi usare la procedura seguente per provare usando il [file Retail Analysis Sample PBIX](../create-reports/sample-datasets.md).
