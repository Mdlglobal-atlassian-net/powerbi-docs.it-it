...
I pacchetti R supportati per il **servizio Power BI** si trovano nella sezione seguente, intitolata **Pacchetti supportati**. Se si vuole richiedere il supporto di un pacchetto R non trovato in tale elenco, inviare la richiesta a [Power BI Ideas](https://ideas.powerbi.com).
...
|accento circonflesso|6.0-78|https://cran.r-project.org/web/packages/caret/index.html|
...
|Matrice|1.2-12|https://cran.r-project.org/web/packages/Matrix/index.html|
