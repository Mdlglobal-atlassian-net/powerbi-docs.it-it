...
2. È possibile porre una domanda digitandola in Domande e risposte o fare clic su un riquadro per aprire il report sottostante. 
    ...
    Modificare il dashboard e il report per adattarli alle esigenze dell'organizzazione. [Distribuire quindi l'app ai colleghi](../collaborate-share/service-create-distribute-apps.md).
...
* [Distribuire le app ai colleghi](../collaborate-share/service-create-distribute-apps.md)
