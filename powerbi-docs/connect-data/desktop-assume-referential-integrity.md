...
Altre informazioni sulle [relazioni in Power BI](../transform-model/desktop-create-and-manage-relationships.md)

Altre informazioni su [Visualizzazione delle relazioni in Power BI Desktop](../transform-model/desktop-relationship-view.md).
