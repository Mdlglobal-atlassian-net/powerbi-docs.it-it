...
![Azzurro ghiaccio](media/service-azure-and-power-bi/azure_1.png)
...
È possibile iniziare con una connessione semplice a un database SQL di Azure, quindi creare report per monitorare i progressi dell'azienda. Con [Power BI Desktop](../fundamentals/desktop-getting-started.md), è possibile creare report che identificano le tendenze e gli indicatori di prestazioni chiave che fanno progredire l'azienda.
...
Se si hanno dati molto complessi, provenienti da qualsiasi tipo di origine, Non c'è problema. Con **Power BI Desktop**e i servizi di Azure, basta un tocco nella finestra di dialogo **Recupera dati** per stabilire subito una connessione. All'interno della stessa query è possibile connettersi al **database SQL di Azure**, all'origine dati di **Azure HDInsight** e all'**Archiviazione BLOB di Azure** (o all'**Archiviazione tabelle di Azure**), quindi selezionare solo i subset necessari contenuti all'interno di ciascuno e ottimizzarli da questa posizione.
...
* [Archiviazione di Azure](https://azure.microsoft.com/services/storage/) (Archiviazione BLOB e Archiviazione tabelle)
...
Per informazioni sulle API Power BI, vedere il [portale per gli sviluppatori di Power BI](https://dev.powerbi.com).
...
Le combinazioni di **Azure** e **Power BI** sono illimitate e possono aprire possibilità e opportunità esclusive e mirate alle esigenze dell'azienda. Per altre informazioni sui **servizi di Azure**, consultare questa [pagina di panoramica](https://docs.microsoft.com/azure/machine-learning/team-data-science-process/plan-your-environment) che descrive gli **scenari di analisi dei dati con Azure** e le soluzioni per trasformare le origini dati in intelligence per far progredire l'azienda.
