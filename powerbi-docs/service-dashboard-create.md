---
title: Guida introduttiva - Creare un dashboard di Power BI da un report
description: Creare un dashboard di Power BI da un report
services: powerbi
documentationcenter: 
author: mihart
manager: kfile
...
---
# <a name="create-a-power-bi-dashboard-from-a-report"></a>Creare un dashboard di Power BI da un report
