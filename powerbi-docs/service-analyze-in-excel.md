...
* Le tabelle pivot di Excel non supportano l'aggregazione di campi numerici mediante trascinamento della selezione. Il set di dati in Power BI *deve avere misure predefinite*. Vedere le informazioni sulla [creazione di misure](desktop-measures.md).
