...
[Creare un riquadro con un numero di grandi dimensioni da un report](power-bi-visualization-big-number-report.md)

[Creare un riquadro con un numero di grandi dimensioni da Domande e risposte](power-bi-visualization-big-number.md)
